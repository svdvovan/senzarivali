...
public class senza_losiny {
    public static void main(String[] args) throws IOException {
        ...
        Elements link1 = doc1.getElementsByClass("dark_link");
        Elements prices = doc1.getElementsByClass("current_price got_bold pink");
        Elements Names = doc1.select("a[data-product]");
        System.out.print(  link1.text() + " ; " );

       int y = 0;
//        for (Element link1 : links1) {
  //          System.out.print( Names.get(y).attr("data-product") + " ; " + link1.text() + " ; " + prices.get(y).text() +" ; " );
